def HGNC_to_Recon_converter(inFilePath, outFilePath, myModel): 
	...
	with open(inFilePath, mode = 'r') as CRISPR_data_new: 
		new_lines = []
		k = 0
		found2 = 0
		unmatched = []
...
if __name__ == '__main__': 
	# example of usage : 
	import cobra.io as co
	inFilePath = r'C:\Users\mario\OneDrive\Documents\SURE\CRANKS_HITS\3-BrPA_7_uM_hits'
	outFilePath = r'C:\Users\mario\OneDrive\Documents\SURE\CRANKS_HITS_RECON\3-BrPA_7_uM_hits_Recon'
	HGNC_to_Recon_converter(inFilePath, outFilePath, myModel=co.read_sbml_model('Recon3.xml'))
